...
Bajo los supuestos de normalidad de los errores, se puede demostrar que los estimadores de máxima verosimilitud de \( \beta_0 \) y \( \beta_1 \) son **idénticos** a los obtenidos mediante **mínimos cuadrados ordinarios (MCO)**. Sin embargo, la **estimación de la varianza \( \sigma^2 \) difiere** entre ambos métodos:
...
- **Los estimadores EMV de \( \beta_0 \) y \( \beta_1 \) coinciden con los obtenidos por mínimos cuadrados ordinarios (MCO)**.

- **La estimación de la varianza \( \sigma^2 \) es diferente entre ambos métodos**: MCO usa \( n-2 \) para que sea insesgado, mientras que EMV usa \( n \), lo que introduce un pequeño sesgo pero mejora la eficiencia del estimador.
...
En el modelo de regresión lineal, se asume que los **errores \( \varepsilon_i \) son independientes**, es decir:
...
De lo anterior se concluye que **los EMV de \( \beta_0 \) y \( \beta_1 \) coinciden con los estimadores obtenidos por MCO**.
